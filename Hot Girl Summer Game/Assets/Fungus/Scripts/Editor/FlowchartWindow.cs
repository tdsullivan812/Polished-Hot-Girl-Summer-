...
namespace Fungus.EditorUtils
{
    public class FlowchartWindow : EventWindow
    {
        ...
        protected virtual void HandleEarlyEvents(UnityEngine.Event e) 
        {
            switch (e.type)
            {
        ...
        protected virtual void OnGUI()
        {
            ...
            HandleEarlyEvents(UnityEngine.Event.current);
            ...
            DrawFlowchartView(UnityEngine.Event.current);
            ...
            try
            {
                DrawOverlay(UnityEngine.Event.current);
            }
            catch (Exception)
            {
            ...
            base.HandleEvents(UnityEngine.Event.current);
        ...
        protected virtual void DrawOverlay(UnityEngine.Event e)
        {
            // Main toolbar group
        ...
        protected virtual void DrawVariablesBlock(UnityEngine.Event e)
        {
            // Variables group
            GUILayout.BeginHorizontal();
            {
        ...
        protected virtual void DrawBlockPopup(UnityEngine.Event e)
        {            
            blockPopupSelection = Mathf.Clamp(blockPopupSelection, 0, filteredBlocks.Length - 1);
        ...
        protected override void OnMouseDown(UnityEngine.Event e)
        {
        ...
        protected override void OnMouseDrag(UnityEngine.Event e)
        {
        ...
        protected override void OnRawMouseUp(UnityEngine.Event e)
        {
            var hitBlock = GetBlockAtPoint(e.mousePosition);
        ...
        protected override void OnScrollWheel(UnityEngine.Event e)
        {
        ...
        protected virtual void DrawFlowchartView(UnityEngine.Event e)
        {
        ...
        {
            return (UnityEngine.Event.current != null && UnityEngine.Event.current.shift) || EditorGUI.actionKey;
        }
        ...
        protected override void OnValidateCommand(UnityEngine.Event e)
        {
        ...
        protected override void OnExecuteCommand(UnityEngine.Event e)
        {
