...
namespace Fungus.EditorUtils
{
    ...
    public class BlockEditor : Editor
    {
        ...
        public virtual void DrawButtonToolbar()
        {
            ...
            // Previous Command
            if ((UnityEngine.Event.current.type == EventType.KeyDown) && (UnityEngine.Event.current.keyCode == KeyCode.PageUp))
            {
                SelectPrevious();
            ...
            // Next Command
            if ((UnityEngine.Event.current.type == EventType.KeyDown) && (UnityEngine.Event.current.keyCode == KeyCode.PageDown))
            {
                SelectNext();
                GUI.FocusControl("dummycontrol");
                UnityEngine.Event.current.Use();
